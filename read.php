            ...
            <div class="header-top">
                <div class="container">
                    <div class="row">
                        ...
                        <a  href="login.php" button type="button" class="btn btn-primary" style="width: 10%; height: 5%; margin-top: 3%; margin-right: 3%; margin-left: 3%;">login/register</button></a>
...
<label>Image</label>
    <p><b><?php echo "<td style='width: 600px'> <img style='150%;' src='images/$image'</td>"; ?></b></p>
 </div>    
  <div class="form-group1">
<label>Name</label>
