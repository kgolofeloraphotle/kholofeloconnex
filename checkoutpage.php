...
foreach ($_SESSION as $key=>$val) {$total++;} echo $total;?>
            ...
            <div class="menu js-top-menu position-static hidden-sm-down" id="_desktop_top_menu">
                <ul class="top-menu container" id="top-menu" data-depth="0">
                    <li class="home_icon"><a href="logged.php"><i class="icon-home"></i><span>Home</span></a></li>
...
include_once("functions-page.php");
    ...
    $name
    [P/item] R$price 
        <input type='number' min='0' name='product' value= '$quantity' style='text-align: center;'>
    ...
    echo("Toatal price R$total");
   
 ?> 
 <style>
  margin-right: 500;   
 <a  href="payment.php" button type="button" class="btn btn-primary" style="width: 16%; height: 5%; margin-top: 3%; margin-right: 3%;">Make Payment</button></a>
<a  href="logged.php" button type="button" class="btn btn-primary" style="width: 20%; height: 5%; margin-top: 3%; margin-right: 3%;">Continue Shopping</button></a>
</style>
</div>
