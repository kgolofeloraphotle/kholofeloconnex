                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div id="_desktop_search_widget" class="col-lg-4 col-md-4 col-sm-12 search-widget hidden-sm-down ">
                         ...
                         <a  href="index.php" button type="button" class="btn btn-primary" style="width: 10%; height: 5%; margin-top: 3%; margin-right: 3%; margin-left: 3%;"><b>Logout</b></a></button> or <a href="adminReg.php" button type="button" class="btn btn-primary" style="width: 15%; height: 5%; margin-top: 3%; margin-right: 3%; margin-left: 3%;"><b> Register New Admin</b></a></button>
...
foreach ($_SESSION as $key=>$val) {$total++;} echo $total;?>
            ...
            <div class="menu js-top-menu position-static hidden-sm-down" id="_desktop_top_menu">
                ...
                <li class="home_icon"><a href="index.php"><i class="icon-home"></i><span>Home</span></a></li>
                    ...
                    <li class="category" id="category-403">
                        <a class="dropdown-item" href="user.php" data-depth="0">
                        <i class='fas fa-users'></i>
                        </a>
                    </li>

                    <li class="category" id="category-403">
                        <a class="dropdown-item" href="payment.php" data-depth="0">
                            customer
                        </a>
                    </li>

                    <li class="category" id="category-403">
                        <a class="dropdown-item" href="logged.php" data-depth="0">
                        <i class='fas fa-shop' height="60%" width="60%"></i>  
                        </a>
                    </li>
...
echo "<td>";
echo '<a href="product-view.php?id='.$row['id'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
